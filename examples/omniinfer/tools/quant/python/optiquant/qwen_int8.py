...
def main(args, bf16_path, output_path, model_name="Qwen/Qwen3"):
    ...
    for i in range(94):
        ...
        disable_names.append(f"model.layers.{i}.self_attn.k_proj.weight")
        disable_names.append(f"model.layers.{i}.self_attn.v_proj.weight")
        disable_names.append(f"model.layers.{i}.self_attn.o_proj.weight")
